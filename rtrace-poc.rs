...
fn debug_thread(pid: nix::unistd::Pid) {
	...
	while debugging {
		...
		let orig_rax   = registers.orig_rax as u8;
...
fn syscall_lookup(orig_rax: u8) -> String {		// lookup table from: http://blog.rchapman.org/posts/Linux_System_Call_Table_for_x86_64/
